...
// fun��o que insere dados dos clientes
...
void imprimir_lista(No *Lista, gastos notaFiscal)
{
  No *aux = Lista;
  printf("\n\n\n");
  printf("\t================ Relat�rio de Impostos ===============\n\n\t*Na compra acima de 1500 o cliente � beneficiado com desconto de 10 porcento*\n\n");
  while (aux != NULL)
  {
  ...
  if (notaFiscal.total_geral > 1500)
  {
    ...
    printf("Este cliente teve uma bonifica��o de 10 porcento de desconto!\n");
  }
}
...
int main()
{
  ...
  printf("\nC�lculos de impostos para Nota Fiscal \n");
  while (flag == 0)
  {
